...
export const PERSONAL_INFO = {
  ...
  bio: "Passionate developer crafting immersive digital experiences with modern web technologies and 3D graphics. Specializing in React, Next.js, and Three.js.",
